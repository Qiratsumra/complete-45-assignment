...
var guestLists = ["Feroz", "Zaheer", "Abari"];
...
var totalGuests = guestLists;
totalGuests.splice(2, 0, "Hadi");
// priny the message for the guest;
totalGuests.forEach(function (totalGuest) { return console.log("".concat(totalGuest, " you are invited for grand dinner")); });
